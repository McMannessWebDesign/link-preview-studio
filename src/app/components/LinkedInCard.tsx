  ...
  return (
    <div className="preview-card">
      ...
      >
        ...
        */}
        <div className="w-[100px] h-[100px] self-center bg-neutral-100 dark:bg-neutral-800 flex-shrink-0 overflow-hidden flex items-center justify-center rounded-md m-2">
          {image ? (
